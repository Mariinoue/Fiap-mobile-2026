...
//   return (
//     <View style={{ flex: 1 }}>
//       <Text style={{ fontSize: 32, color: "purple" }}>Tela D</Text>
//     </View>
//   )
// }
...
//           header: () => <Text style={{ fontSize: 32, color: "black" }}>Cabeçalho</Text>
//         }}>
//           <Screen name="TelaA" component={TelaA} options={{ tabBarIcon: () => <Icons name="silverware-fork-knife" />, tabBarLabel: () => <Text>Diet</Text>, header: () => <Text>Diet</Text> }} />
//           <Screen name="TelaB" component={TelaB}  options={{ tabBarIcon: () => <Icons name="silverware-fork-knife" />, tabBarLabel: () => <Text>Diet</Text>, header: () => <Text>Diet</Text> }} />
//           <Screen name="TelaC" component={TelaC} options={{ tabBarIcon: () => <Icons name="silverware-fork-knife" />, tabBarLabel: () => <Text>Diet</Text>, header: () => <Text>Diet</Text> }} />
//           <Screen name="TelaD" component={TelaD} options={{ tabBarIcon: () => <Icons name="silverware-fork-knife" />, tabBarLabel: () => <Text>Diet</Text>, header: () => <Text>Diet</Text> }} />
//         </Navigator>
...
export default function App() {
  ...
  const [lista, setLista] = useState<Array<Contato>> ([
    {id: "001", nome: "joao Silva", telefone: "11999999999", email: "joao@teste.com"}
  ]);
